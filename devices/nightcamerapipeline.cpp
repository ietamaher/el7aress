...
NightCameraPipelineDevice::NightCameraPipelineDevice(DataModel *dataModel, QWidget *parent)
    : QWidget(parent),
...
void NightCameraPipelineDevice::buildPipeline()
{
    ...
    gst_caps_unref(caps3);
     ...
     glimagesink = gst_element_factory_make("glimagesink", "src_glimagesink");
    ...
    gst_bin_add_many(GST_BIN(pipeline),
                     ...
                     nvosd,
                     nvvidconvsrc3, capsfilter3, tee, queue_display, glupload, glimagesink,
                     queue_process, appsink, NULL);
    ...
    if (!gst_element_link_many(queue_display, glupload, glimagesink, NULL) ||
        ...
        g_error("Failed to link after queue_display elements!");
    }
    ...
    if (gst_pad_link(tee_src_pad1, queue_display_sink_pad) != GST_PAD_LINK_OK ||
        ...
        g_error("Failed to link tee pads!");
    }
...
GstPadProbeReturn NightCameraPipelineDevice::osd_sink_pad_buffer_probe(GstPad *pad, GstPadProbeInfo *info, gpointer user_data)
{
    ...
    for (NvDsMetaList *l_frame = batch_meta->frame_meta_list; l_frame != NULL; l_frame = l_frame->next)
    {
        ...
        double elevationDegrees = elevation;
        ...
        // **Draw Azimuth Line**
        double azimuthDegrees = azimuth;//self->m_dataModel->getAzimuth(); // Implement this method
